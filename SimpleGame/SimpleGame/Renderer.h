...
private:
	...
	GLuint m_AFBOAttach_1_Texture = 0;	// ATTACHMENT1
	GLuint m_AFBOAttach_2_Texture = 0;	// ATTACHMENT2
	GLuint m_AFBOAttach_3_Texture = 0;	// ATTACHMENT3
	GLuint m_AFBOAttach_4_Texture = 0;	// ATTACHMENT4
